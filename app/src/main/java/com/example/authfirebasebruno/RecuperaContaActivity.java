...
import com.example.authfirebasebruno.databinding.ActivityCadastroBinding;
import com.example.authfirebasebruno.databinding.ActivityRecuperaContaBinding;
...
public class RecuperaContaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnRecuperaConta.setOnClickListener(view -> validaDados());
    }
    ...
    private void recuperaContaFirebase(String email){
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(task -> {
            if (task.isSuccessful()){
                Toast.makeText(this, "Já pode verificar o seu email;.", Toast.LENGTH_SHORT).show();
            }else {
